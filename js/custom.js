...
function isOnScreen(elem) {
  ...
  jQuery(document).ready(function ($) {
    ...
    $(".woocommerce-pagination").html('<img src="' + globals.spinner + '" class="woocommerce-pagination__spinner" alt="Loading More" width="25" height="25" />');
    ...
    $(".accordion-panel").on("click", function (e) {
      $(this)
        .siblings()
        .css({ zIndex: null })
        .removeClass("accordion-panel--open");
